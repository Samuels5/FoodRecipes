<template>
  <div class="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50">
    <!-- Hero Section -->
    <div
      class="hero-section bg-gradient-to-r from-orange-500 to-red-500 text-white py-16 mb-8"
    >
    ...
    <div class="container mx-auto px-4 pb-8">
      ...
      <div
        class="mb-8 bg-white p-6 rounded-2xl shadow-lg border border-orange-100"
      >
        ...
        <div class="mt-6 flex gap-3">
          ...
          <div
            class="text-sm text-gray-600 flex items-center bg-orange-50 px-4 py-3 rounded-xl"
          >
      ...
      <div v-else-if="error" class="text-center py-16">
        <div
          class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-2xl max-w-md mx-auto"
        >
        ...
        >
          <NuxtLink :to="`/recipe/${recipe.id}`" class="block group">
            ...
            <div class="p-6">
              <div class="flex items-start justify-between mb-3">
                <h2
                  class="text-xl font-bold text-gray-800 group-hover:text-orange-600 transition-colors line-clamp-2"
                >
                  {{ recipe.title }}
                </h2>
                <span
              ...
              <div
                class="flex justify-between items-center text-sm border-t pt-3"
              >
                <RecipeLikes
                  :like-count="
          ...
          <div class="px-6 pb-6">
            ...
            <div v-else-if="getRecipePricing(recipe)" class="space-y-3">
              <div
                class="flex items-center justify-center bg-blue-50 text-blue-700 font-medium text-sm py-2 px-4 rounded-xl border border-blue-200"
              >
                <svg
                  class="w-4 h-4 mr-2"
                  fill="currentColor"
