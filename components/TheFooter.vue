<template>
  <footer
    class="bg-gradient-to-r from-orange-600 to-red-600 text-white py-8 mt-16"
  >
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-xl font-bold mb-4">Food Recipes</h3>
      ...
      <div
        class="border-t border-orange-500 mt-8 pt-8 text-center text-orange-100"
      >
